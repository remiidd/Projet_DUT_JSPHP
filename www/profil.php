    ...
    <div class="content">
      <div class="wrapp">
        <div id="presentation">
          ...
          <div class="pp"><img class="profilpicture" src="<?php if($data["photo_profil"]!=null) { echo $data["photo_profil"]; } else { if() ?>src/media/default_profil_picture.jpg<?php } ?>" alt="Default profil picture"/></div>

    ...
    <div class="content">
      <div class="wrapp">
        <div id="presentation">
          ...
          <div id="pp"><img class="profilpicture" src="<?php if($data["photo_profil"]!=null) { echo $data["photo_profil"]; } else { ?>src/media/default_profil_picture.jpg<?php } ?>" alt="Default profil picture"/></div>
        ...
        <div id="infos">
          ...
          <table id="tableau_infos_perso">
            ...
            <tr>
              ...
              <td><p><strong><a class="no_deco_link modif_infos_boutons" href="friends.php?id=<?php echo $_GET["id"]; ?>">Liste des amis</a></strong></p></td>
            </tr>
          </table>
        <?php if($_SESSION["idcon"]==$_GET["id"]){ ?>
          <p><a href="parametres-<?php echo $_SESSION["idcon"]; ?>">Modifier vos informations personnelles</a></p>
          </div>

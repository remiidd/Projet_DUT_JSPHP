...
<html lang="fr">
  ...
  <body>
    ...
    <div class="content">
      <div id="presentation">
        <div class="cover" style="background-repeat: no-repeat;background-image:url(<?php if($data["photo_couv"]!=null) { echo $data["photo_couv"]; } else { ?>src/media/default_profil_cover.jpg<?php } ?>);"></div>

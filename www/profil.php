      ...
      <div class="wrapp">
        ...
        <div class="feed_profil">
          ...
          while($feed = $reponse->fetch()) {
            ?><div><hr>
              <h5><a href="<?php echo "profil-".$feed["profil"]; ?>"><img class="pp_posts" src="<?php if($data["photo_profil"]!=null) { echo $data["photo_profil"]; } else { ?>src/media/default_profil_pp.jpg<?php } ?>" alt="Default profil cover"/><?php echo " ".$feed["nom_createur"]; ?></h5></a><p>

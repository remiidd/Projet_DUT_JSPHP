...
while($feed = $reponse->fetch()) {
  ...
  ?><div><hr>
    ...
    <ul class="barre_posts">
      ...
      ?>
      <li class="elements_barre_posts"><a onclick="liker_post(<?php echo $feed["id"].",".$_SESSION["idcon"]; ?>)"><?php echo $feed["nb_like"];?> Likes <i class="<?php if($okk){ echo "fas"; } else { echo "far"; } ?> fa-thumbs-up"></i></a></li>

...
<html lang="fr">
  ...
  <body>
    ...
    <div class="content">
      <h5><img class="pp_posts_max" src="<?php if($data["photo_profil"]!=null) { echo $data["photo_profil"]; } else { ?>src/media/default_profil_cover.jpg<?php } ?>" alt="Default profil cover"/><a class="no_deco_link" href="<?php echo "profil.php?id=".$data["profil"]; ?>"><?php echo $data["nom_createur"]; ?></a></h5>

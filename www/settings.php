  ...
  <body>
    ...
    <div class="content">
      <div class="wrapp">
        ...
        <p class="marge">Email : <?php echo $data["email"]; ?> <a class="modif_info_bouton"><i class="fas fa-pencil-alt"></i> Modifier</a><i class="txt_modif_email"><form><input type="text" name="email"/><input id="inscriBout" type="submit" value="Valider" onclick="modif()"/></form></i></p>

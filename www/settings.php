  ...
  <body>
    ...
    <div class="content">
      <div class="wrapp">
        ...
        <p class="marge">Emploi : <a class="modif_info_bouton_emploi"><i class="fas fa-plus"></i> Ajouter</a><i class="txt_modif_ville"><form action="" method="post"><input required type="text" name="emploi"/><input id="inscriBout" type="submit" value="Valider" onclick="modif()"/></form></i></p>

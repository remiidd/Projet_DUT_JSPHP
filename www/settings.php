  ...
  <body>
    ...
    <div class="content">
      <div class="wrapp">
        ...
        <p class="ligne marge">Email : <?php echo $data["email"]; ?> <i class="txt_modif_email"><form action="modif()"><input type="text" name="email"/><input type="submit" value="modifier"/></form></i> <a class="modif"><i class="fas fa-pencil-alt"></i> Modifier</a></p>

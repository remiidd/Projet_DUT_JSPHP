  ...
  <body>
    ...
    <div class="content">
      <div class="wrapp">
        ...
        <ul><li><p class="marge">Email : <?php echo $data["email"]; ?></p></li><li><p class="txt_modif_email">salut</p></li><li><p><a class="modif"><i class="fas fa-pencil-alt"></i> Modifier</a></p><li></ul>
